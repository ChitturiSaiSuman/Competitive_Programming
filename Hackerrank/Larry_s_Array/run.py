...
if ".java" in program_to_be_executed:
    ...
    start = time.time()
    os.system("java Main < in.in > out.out 2> err.err")
    end = time.time()
    ...
    start = time.time()
    os.system("./runner < in.in > out.out 2> err.err")
    end = time.time()
    ...
    start = time.time()
    os.system("python3 "+program_to_be_executed+" < in.in > out.out 2> err.err")
    end = time.time()
